        ...
        customerService.getCustomersMedium().then((data) => {
            ...
            if (tempData.length > 0) {
                ...
                for (let x in tempData) {
                    ...
                    // console.log("idPob typo ", typeof x);
                    // console.log("idPoblacion[x]", tempData[x]);
                    // tempData[x]["idPoblacion"] = parseInt(idPoblacion);
                    // setIdPoblacion(indexPoblacion++)
                    // tempData[idPoblacion]
                }
                // console.log("dat1 ", tempData);
                // console.log("arrIdPoblacion ", arrIdPoblacion);
            }
